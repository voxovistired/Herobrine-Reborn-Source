...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["Into The Mainframe.",				"Beat Crashlog.",									'frame',				 true],
		["Backspace.",						"Beat Deletion.",									'delete',				 true],
		["Shifted Worlds.",					"Beat Diverge.",									'diverge',				 true],
		["Why Did You Break The Block??.",	"Beat Desolation.",									'bedrock',				 true],
	];
...
class AchievementObject extends FlxSpriteGroup {
	...
	public function new(name:String, ?camera:FlxCamera = null)
	{
		...
		var achievementBG:FlxSprite = new FlxSprite(60, 50).loadGraphic(Paths.image('achivebg'));
		achievementBG.width = 420;
		achievementBG.height = 120;

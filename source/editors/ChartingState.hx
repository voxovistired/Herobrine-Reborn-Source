...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function addOtherUI()
	{
		var tab_group_other = new FlxUI(null, UI_box);
		tab_group_other.name = 'Other';

		var UI_songDiff = new FlxUIInputText(10, UI_songTitle.y + UI_songTitle.height + 2, 70, CoolUtil.difficultyString().toLowerCase(), 8);
		...
		var check_dad2 = new FlxUICheckBox(UI_songDiff.x, UI_songDiff.y + 100, null, null, "Add Second Dad", 100);

		var check_bf2 = new FlxUICheckBox(check_dad2.x, check_dad2.y + 100, null, null, "Add Second Boyfriend", 100);

		var player4DropDown = new FlxUIDropDownMenuCustom(check_bf2.x + 140, check_bf2.y + 40, FlxUIDropDownMenuCustom.makeStrIdLabelArray(characters, true), function(character:String)
		{
			_song.player3 = characters[Std.parseInt(character)];
			updateHeads();
		});
		player4DropDown.selectedLabel = _song.player3;
		blockPressWhileScrolling.push(player4DropDown);

		var player5DropDown = new FlxUIDropDownMenuCustom(player4DropDown.x + 200, player4DropDown.y, FlxUIDropDownMenuCustom.makeStrIdLabelArray(characters, true), function(character:String)
		{
			_song.player4 = characters[Std.parseInt(character)];
			updateHeads();
		});
		player5DropDown.selectedLabel = _song.player4;
		blockPressWhileScrolling.push(player5DropDown);

		var player6DropDown = new FlxUIDropDownMenuCustom(player4DropDown.x, player4DropDown.y - 100, FlxUIDropDownMenuCustom.makeStrIdLabelArray(characters, true), function(character:String)
		{
			_song.player5 = characters[Std.parseInt(character)];
			updateHeads();
		});
		player6DropDown.selectedLabel = _song.player5;
		blockPressWhileScrolling.push(player6DropDown);

		var player7DropDown = new FlxUIDropDownMenuCustom(player6DropDown.x + 100, player6DropDown.y, FlxUIDropDownMenuCustom.makeStrIdLabelArray(characters, true), function(character:String)
		{
			_song.player6 = characters[Std.parseInt(character)];
			updateHeads();
		});
		player7DropDown.selectedLabel = _song.player6;
		blockPressWhileScrolling.push(player7DropDown);

		tab_group_other.add(new FlxText(UI_songDiff.x + UI_songDiff.width + 1, UI_songDiff.y, 0, "Difficulty:", 9));
		tab_group_other.add(new FlxText(player4DropDown.x, player4DropDown.y - 15, 0, 'Second Boyfriend:'));
		tab_group_other.add(new FlxText(player5DropDown.x, player5DropDown.y - 15, 0, 'Third Boyfriend:'));
		tab_group_other.add(new FlxText(player6DropDown.x, player6DropDown.y - 15, 0, 'Forth Boyfriend:'));
		tab_group_other.add(new FlxText(player7DropDown.x, player7DropDown.y - 15, 0, 'Fifth Boyfriend:'));
		tab_group_other.add(UI_songDiff);
		tab_group_other.add(player4DropDown);
		tab_group_other.add(player5DropDown);
		tab_group_other.add(player6DropDown);
		tab_group_other.add(player7DropDown);
		UI_box.addGroup(tab_group_other);
	}
